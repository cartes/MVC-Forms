...
<head>
    ...
    <link rel="stylesheet" href=""<?php echo get_template_path() ?>assets/css/pace.css">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pace/1.0.2/pace.min.js"></script>

    <link href="<?php echo get_template_path() ?>/assets/vendors/material-icons/material-icons.css" rel="stylesheet" type="text/css">
    <link href="<?php echo get_template_path() ?>/assets/vendors/mono-social-icons/monosocialiconsfont.css" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo get_template_path() ?>/assets/vendors/weather-icons-master/weather-icons.min.css" rel="stylesheet" type="text/css">
    <link href="<?php echo get_template_path() ?>/assets/vendors/weather-icons-master/weather-icons-wind.min.css" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo get_template_path() ?>/assets/css/dashboard.css" rel="stylesheet" type="text/css">
    <!-- Head Libs -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>

</head>
<body class="dashboard header-light sidebar-dark sidebar-expand pace-done">
